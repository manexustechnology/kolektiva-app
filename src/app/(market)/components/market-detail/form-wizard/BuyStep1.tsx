      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3 p-3 shadow-sm shadow-zinc-300 text-teal-600 rounded-2xl">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base font-medium">30,00 LSK</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div
              className={cn(
                ...
                formData?.qtyToken === 1 ? "bg-teal-50 border border-teal-600" : "shadow-sm shadow-zinc-300",
              )}
              onClick={() => setTokenQty(1)}
            >
              <p className="text-base font-medium text-teal-600">1 token</p>
              <p className="text-xs text-zinc-700">5,00 LSK</p>
            </div>
            <div
              className={cn(
                "flex flex-col gap-0.5 justify-center items-center rounded-lg p-3 cursor-pointer",
                formData?.qtyToken === 5 ? "bg-teal-50 border border-teal-600" : "shadow-sm shadow-zinc-300",
              )}
              onClick={() => setTokenQty(5)}
            >
              <p className="text-base font-medium text-teal-600">5 token</p>
              <p className="text-xs text-zinc-700">25,00 LSK</p>
            </div>
            <div
              className={cn(
                "flex flex-col gap-0.5 justify-center items-center rounded-lg p-3 cursor-pointer",
                formData?.qtyToken === 10 ? "bg-teal-50 border border-teal-600" : "shadow-sm shadow-zinc-300",
              )}
              onClick={() => setTokenQty(10)}
            >
              <p className="text-base font-medium text-teal-600">10 token</p>
              <p className="text-xs text-zinc-700">50,00 LSK</p>
            </div>
            <div
              className={cn(
                "flex flex-col gap-0.5 justify-center items-center rounded-lg p-3 cursor-pointer",
                formData?.qtyToken === 25 ? "bg-teal-50 border border-teal-600" : "shadow-sm shadow-zinc-300",
              )}
              onClick={() => setTokenQty(25)}
            >
              <p className="text-base font-medium text-teal-600">25 token</p>
              <p className="text-xs text-zinc-700">125,00 LSK</p>
            </div>
            <div
              className={cn(
                "flex flex-col gap-0.5 justify-center items-center rounded-lg p-3 cursor-pointer",
                formData?.qtyToken === 50 ? "bg-teal-50 border border-teal-600" : "shadow-sm shadow-zinc-300",
              )}
              onClick={() => setTokenQty(50)}
            >
              <p className="text-base font-medium text-teal-600">50 token</p>
              <p className="text-xs text-zinc-700">250,00 LSK</p>
            </div>
            <div
              className={cn(
                "flex flex-col gap-0.5 justify-center items-center rounded-lg p-3 cursor-pointer",
                formData?.qtyToken === 100 ? "bg-teal-50 border border-teal-600" : "shadow-sm shadow-zinc-300",
              )}
              onClick={() => setTokenQty(100)}
            >
              <p className="text-base font-medium text-teal-600">100 token</p>
              <p className="text-xs text-zinc-700">500,00 LSK</p>
            </div>
          </div>
        </div>
      </div>
