  ...
  return (
    <>
      <div className="flex flex-col gap-6">
        <div className="flex gap-4 w-full">
          <div className="flex flex-col gap-3 w-full rounded-2xl shadow-md p-4">
            <div className="flex flex-col gap-1">
              <p className="text-base font-medium text-zinc-700">Total Investment Value</p>
              <p className="text-xl font-bold text-teal-600">Rp 389,772,113</p>
            </div>
            <Divider className="border-zinc-200 !m-0" />
            <div className="flex flex-col gap-4">
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Underlying asset price</p>
                <p className="text-sm font-medium text-zinc-700">Rp 370,700,100</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Closing costs</p>
                <p className="text-sm font-medium text-zinc-700">Rp 500,000</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Upfront DAO LLC fees</p>
                <p className="text-sm font-medium text-zinc-700">Rp 60,000</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Operating reserve (2%)</p>
                <p className="text-sm font-medium text-zinc-700">Rp 0 / Rp 4,000,000</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Kolektiva AI listing fee (5%)</p>
                <p className="text-sm font-medium text-zinc-700">Rp 5,000,000</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-3 w-full rounded-2xl shadow-md p-4">
            <div className="flex flex-col gap-1">
              <p className="text-base font-medium text-zinc-700">Projected Annual Return</p>
        ...
        <div className="flex flex-col gap-3 w-full rounded-2xl shadow-md p-4">
          <div className="flex flex-col gap-1">
            <p className="text-base font-medium text-zinc-700">Annual gross rents</p>
            <p className="text-xl font-bold text-teal-600">Rp 32,033,896</p>
          </div>
          <Divider className="border-zinc-200 !m-0" />
          <div className="flex gap-4">
            <div className="flex flex-col gap-4 w-full">
              <div className="flex flex-col">
                ...
                <p className="text-sm font-medium text-zinc-700">Rp 0</p>
              </div>
              <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm font-medium text-zinc-700">Rp 12,000,000</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Annual DAO LLC administration and filing fees</p>
                <p className="text-sm font-medium text-zinc-700">Rp 5,000,000</p>
              </div>
            </div>
            <div className="flex flex-col gap-4 w-full">
              <div className="flex flex-col">
                ...
                <p className="text-sm font-medium text-zinc-700">Rp 149,380,200</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Monthly cash flow</p>
                <p className="text-sm font-medium text-zinc-700">Rp 12,448,332</p>
              </div>
              <div className="flex flex-col">
                <p className="text-sm text-zinc-500">Projected Annual Cash Flow</p>
                <p className="text-sm font-medium text-zinc-700">Rp 149,379,200</p>
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-col gap-3 w-full rounded-2xl shadow-md p-4">
          <p className="text-base font-medium text-zinc-700">Projected returns per token</p>
          <Divider className="border-zinc-200 !m-0" />
          <div className="flex flex-col gap-12">
            <div className="flex gap-4">
              <p className="text-sm text-zinc-500">Tokens purchased</p>
              <p className="text-sm font-medium text-teal-600">2519 / Rp 125,950,933</p>
            </div>
            <div className="flex gap-3 justify-between items-center">
              <p className="text-xs text-zinc-500 w-full max-w-4">1</p>
              <Slider aria-label='slider-ex-6' min={1} max={7464} defaultValue={tokensPurchasedSliderValue} onChange={(val) => setTokensPurchasedSliderValue(val)}>
                <SliderMark
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex gap-3 justify-between items-center">
              <p className="text-xs text-zinc-500 w-full max-w-4">1%</p>
              <Slider aria-label='slider-ex-6' min={1} max={100} defaultValue={appreciationSliderValue} onChange={(val) => setAppreciationSliderValue(val)}>
                <SliderMark
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex gap-3 justify-between items-center">
              <p className="text-xs text-zinc-500 w-full max-w-4">1%</p>
              <Slider aria-label='slider-ex-6' min={1} max={100} defaultValue={cocReturnSliderValue} onChange={(val) => setCocReturnSliderValue(val)}>
                <SliderMark
              ...
              <div className="border rounded-2xl shadow-md overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-zinc-100">
                    <tr>
                      <th scope="col" className="py-3 text-center font-normal text-sm"></th>
                      <th scope="col" className="py-3 text-center font-normal text-sm">Year 5</th>
                      <th scope="col" className="py-3 text-center font-normal text-sm">Year 10</th>
                      <th scope="col" className="py-3 text-center font-normal text-sm">Year 20</th>
                      <th scope="col" className="py-3 text-center font-normal text-sm">Year 30</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      <td className="py-3 px-4 text-sm font-normal">Cumulative Net Cash Flow</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 text-sm font-normal">Cumulative Appreciation Gain</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                    ...
                    <tr>
                      <td className="py-3 px-4 text-sm font-normal">Shining Star</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
                      <td className="py-3 px-4 text-sm font-medium">Rp 125,950,933</td>
