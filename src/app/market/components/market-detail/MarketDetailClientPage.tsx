...
const MarketDetailClientPage: React.FC<MarketDetailClientPageProps> = ({
  ...
  const [pricePerTokenChartSeries, setPricePerTokenChartSeries] = useState<ApexOptions["series"]>([{
    data: [
      [1327359600000, 30.95],
      [1327446000000, 31.34],
      [1327532400000, 31.18],
  ...
  const [pricePerTokenChartOptions, setpricePerTokenChartOptions] = useState<ApexOptions>({
    chart: {
      type: 'area',
      height: 350,
      zoom: {
        ...
        <div className="w-2/3 flex flex-col gap-6">
          ...
          {isSold && (
            <div className="w-full">
              {ReactApexChart && (<ReactApexChart options={pricePerTokenChartOptions} series={pricePerTokenChartSeries} type="area" height={350} />)}
            </div>
          )}
          <div className="w-full">
